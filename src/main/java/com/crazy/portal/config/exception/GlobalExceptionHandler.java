...
//     * @see com.crazy.portal.aop.OperationAspect setErrorMsgAndThrowException
    ...
    public BaseResponse parameterExceptionHandler(Exception exception) {
        ...
        if(exception instanceof MethodArgumentNotValidException){
            ...
            return new BaseResponse(SystemEnum.REQ_PARAM_FORMAT_ERROR.getCode(),msg);
        }
        ...
        log.error("", exception);
        return new BaseResponse(SystemEnum.EXCEPTION.getCode(), SystemEnum.EXCEPTION.getKey());
    }
    ...
    public BaseResponse getMessageNotReadableErrorMessage(Exception exception){
        ...
        return new BaseResponse(SystemEnum.REQ_PARAM_FORMAT_ERROR.getCode(), errorMessage);
    }
}
